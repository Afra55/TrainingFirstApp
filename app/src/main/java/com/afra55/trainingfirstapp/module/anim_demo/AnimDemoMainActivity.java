...
package com.afra55.trainingfirstapp.module.anim_demo;
 ...
 */
public class AnimDemoMainActivity extends ListActivity {
    /**
    ...
    protected void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        startActivity(new Intent(AnimDemoMainActivity.this, mSamples[position].activityClass));
    }
}
