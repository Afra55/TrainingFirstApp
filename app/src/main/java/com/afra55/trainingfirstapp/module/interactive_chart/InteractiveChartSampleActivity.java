...
package com.afra55.trainingfirstapp.module.interactive_chart;
 ...
 * 多点触摸和表格联动效果
 */
public class InteractiveChartSampleActivity extends BaseActivity {

    private InteractiveLineGraphView mGraphView;

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentLayout(R.layout.activity_interactive_chart);
